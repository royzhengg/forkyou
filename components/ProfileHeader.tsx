...
function makeStyles(c: ReturnType<typeof useThemeColors>) {
  return StyleSheet.create({
    ...
    badge: { flexDirection: 'row', alignItems: 'center', backgroundColor: c.surface, borderRadius: 12, paddingHorizontal: 10, paddingVertical: 4 },
    badgeDot: { fontSize: 11, color: c.accent },
    badgeText: { fontSize: 11, color: c.text2 },
    statsCard: { flexDirection: 'row', backgroundColor: c.surface, borderRadius: 14, marginHorizontal: 20, marginTop: 20 },
