  ...
  return (
    <SafeAreaView style={styles.container} edges={['top', 'bottom']}>
      <View style={styles.brand}>
        <Text style={styles.wordmark}>forkyou<Text style={styles.dot}>.</Text></Text>
...
function makeStyles(c: ReturnType<typeof useThemeColors>) {
  return StyleSheet.create({
    ...
    wordmark: { fontFamily: 'DMSerifDisplay-Regular', fontSize: 42, color: c.text, letterSpacing: -1, marginBottom: 16 },
    dot: { color: c.accent },
    tagline: { fontSize: 20, color: c.text2, lineHeight: 28, letterSpacing: -0.2 },
    actions: { paddingBottom: 8, gap: 10 },
    primaryBtn: { backgroundColor: c.text, borderRadius: 20, paddingVertical: 15, alignItems: 'center' },
    primaryBtnText: { fontSize: 15, fontWeight: '500', color: c.bg },
    secondaryBtn: { backgroundColor: c.surface, borderRadius: 20, paddingVertical: 15, alignItems: 'center', borderWidth: 0.5, borderColor: c.border2 },
    ...
    googleBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 10, backgroundColor: '#fff', borderRadius: 20, paddingVertical: 15, borderWidth: 0.5, borderColor: c.border2 },
